...
public class MatrimonyEditItem {
    private String id,name,proftype,religion,image,mprofileid,status;
    public MatrimonyEditItem() {
    }
    public MatrimonyEditItem(String name,String id,String proftype,String image,String religion,String mprofileid,String s) {
        this.name=name;
        this.status=s;
        this.id=id;
