...
/**
 * Created by user-03 on 12/19/2016.
 */
...
public class FollowersAdapter extends RecyclerView.Adapter<FollowersAdapter.ViewHolder> {
    ...
    private List<FollowerItem> followerItem;

    public FollowersAdapter(Activity activity, Context context, List<FollowerItem> item){
        this.mActivity=activity;
        this.mContext=context;
        this.followerItem =item;
    ...
    public FollowersAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new FollowersAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(FollowersAdapter.ViewHolder holder, int position) {
        FollowerItem bind= followerItem.get(position);
        ...
        if(bind.getFollowstatus().equals("true")){
...
//                Log.e("messagefull", String.valueOf(Arrays.asList(objsocial.msgIDFULL)));
                String[]flw= Constants.Followerid;
