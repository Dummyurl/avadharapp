...
public class RealestateFavoriteAdapter extends RecyclerView.Adapter<RealestateFavoriteAdapter.ViewHolder> {
    ...
    public RealestateFavoriteAdapter(Activity activity,Context context,List<RealestateItem> item){
        this.mActivity=activity;
        this.mContext=context;
        this.realestateItems=item;
    }
    @Override
    public RealestateFavoriteAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.realestatemyviewlayout, parent, false);
        return new RealestateFavoriteAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(RealestateFavoriteAdapter.ViewHolder holder, int position) {
...
//                        setAnimationForFavoriteText(response,layout);
    ...
    public void  deleteFavorite(final String uid, final String pid){
        final String[] res = new String[1];
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DatabaseInfo.RealestateDeleteFavoriteURL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.d("Volleyresponse",response.toString());
