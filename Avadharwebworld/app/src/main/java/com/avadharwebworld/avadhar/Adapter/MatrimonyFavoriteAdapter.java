...
public class MatrimonyFavoriteAdapter extends RecyclerView.Adapter<MatrimonyFavoriteAdapter.ViewHolder> {
    ...
    public MatrimonyFavoriteAdapter(Activity activity,Context context,List<MatrimonyFavoriteItem> item){
        this.mActivity=activity;
        this.mContext=context;
        this.MatrimonyFavoriteItems=item;
    }
    @Override
    public MatrimonyFavoriteAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.matrimonylayout, parent, false);
        return new MatrimonyFavoriteAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(MatrimonyFavoriteAdapter.ViewHolder holder, int position) {
        sp=mContext.getSharedPreferences(Constants.PREF_NAME, MODE_PRIVATE);
        sp_uid=sp.getString(Constants.UID,"");
        MatrimonyFavoriteItem bind=MatrimonyFavoriteItems.get(position);
    ...
    public int getItemCount() {
        return MatrimonyFavoriteItems.size();
    }
...
//            InstImage.setLayoutParams(parmsIMG);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    MatrimonyFavoriteItem eduItem=MatrimonyFavoriteItems.get(getLayoutPosition());
//                    eduItem.getId();
