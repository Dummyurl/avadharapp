...
public class RealestateMypackageItem {
    private String id,name,proftype,image,mprofileid,price,details,location,avadharid,activitytype,property;
    public RealestateMypackageItem() {
    }
    public RealestateMypackageItem(String name,String id,String proftype,String image,String religion,String mprofileid,String price,String details,String location,String avid,String activitytype1,String property) {
        this.name=name;
        this.id=id;
