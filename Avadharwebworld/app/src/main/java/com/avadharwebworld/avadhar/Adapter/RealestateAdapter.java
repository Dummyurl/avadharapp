...
public class RealestateAdapter extends RecyclerView.Adapter<RealestateAdapter.ViewHolder> {
    ...
    public RealestateAdapter(Activity activity,Context context,List<RealestateItem> item){
        this.mActivity=activity;
        this.mContext=context;
        this.realestateItems=item;
    }
    @Override
    public RealestateAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.realestatelayout, parent, false);
        return new RealestateAdapter.ViewHolder(itemView);
    }
...
//        holder.religion.setText(bind.getReligion());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
            ...
            price=(TextView)itemView.findViewById(R.id.tv_realestate_price);
            location1=(TextView)itemView.findViewById(R.id.tv_realestate_location);
            type=(TextView)itemView.findViewById(R.id.tv_realestate_type);
            Name=(TextView)itemView.findViewById(R.id.tv_realestate_name);

            favorite=(ImageView)itemView.findViewById(R.id.iv_realestate_favorite);
            thump=(ImageView)itemView.findViewById(R.id.iv_realestate_thump);
            image=(FeedImageView)itemView.findViewById(R.id.iv_realestate_feed);
