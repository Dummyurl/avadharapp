...
public class HisstoryAdapter extends RecyclerView.Adapter<HisstoryAdapter.ViewHolder> {
    ...
    public HisstoryAdapter(Activity activity,Context context,List<HisstoryItem> item){
        this.mActivity=activity;
        this.mContext=context;
        this.hisstoryItems=item;
    }
    @Override
    public HisstoryAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.hisstory_view, parent, false);
        return new HisstoryAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(HisstoryAdapter.ViewHolder holder, int position) {
        final HisstoryAdapter.ViewHolder holder1=holder;
...
////        holder.religion.setText(bind.getReligion());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
            ...
            readmore=(Button)itemView.findViewById(R.id.btn_hisstory_readmore);

            Name=(TextView)itemView.findViewById(R.id.tv_hisstory_view_name);
            date=(TextView)itemView.findViewById(R.id.tv_hisstory_time);
            description=(TextView)itemView.findViewById(R.id.tv_hisstory_view_content);
            title=(TextView)itemView.findViewById(R.id.tv_hisstory_view_title);
            image=(NetworkImageView) itemView.findViewById(R.id.iv_hisstory_view_image);
