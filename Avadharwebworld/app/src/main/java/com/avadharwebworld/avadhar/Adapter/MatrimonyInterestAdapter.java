...
public class MatrimonyInterestAdapter extends RecyclerView.Adapter<MatrimonyInterestAdapter.ViewHolder> {
    ...
    private List<MatrimonyInterestItem> MatrimonyInterestItems;

    ImageLoader imageLoader = AppController.getInstance().getImageLoader();
    public MatrimonyInterestAdapter(Activity activity,Context context,List<MatrimonyInterestItem> item){
        this.mActivity=activity;
        this.mContext=context;
        this.MatrimonyInterestItems=item;
    }
    @Override
    public MatrimonyInterestAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.matrimonylayout, parent, false);
        return new MatrimonyInterestAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(MatrimonyInterestAdapter.ViewHolder holder, int position) {
        sp=mContext.getSharedPreferences(Constants.PREF_NAME, MODE_PRIVATE);
        sp_uid=sp.getString(Constants.UID,"");
        MatrimonyInterestItem bind=MatrimonyInterestItems.get(position);
        ...
        holder.religion.setVisibility(View.GONE);
...
//            InstImage.setLayoutParams(parmsIMG);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    MatrimonyInterestItem eduItem=MatrimonyInterestItems.get(getLayoutPosition());
//                    eduItem.getId();
