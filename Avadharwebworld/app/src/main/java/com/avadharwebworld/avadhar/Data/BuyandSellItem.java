...
public class BuyandSellItem {
    ...
    public BuyandSellItem(String name,String id,String proftype,String image,String religion,String mprofileid,String price,String details,String location,String avid) {
        this.name=name;
        this.id=id;
