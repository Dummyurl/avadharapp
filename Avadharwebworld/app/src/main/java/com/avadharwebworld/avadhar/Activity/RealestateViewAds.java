...
public class RealestateViewAds extends AppCompatActivity {
    ...
    RealestateEditviewAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_realestate_view_ads);
        ...
        rv_realestate=(RecyclerView)findViewById(R.id.recycle_realestate_editview);
        empryview=(TextView)findViewById(R.id.tv_realestate_editview_empty_view);
        adapter=new RealestateEditviewAdapter(this,getApplicationContext(),realestateItems);
...
//        });
    ...
    public void getMatriDetails() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DatabaseInfo.RealestateEditviewURL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        pDialog.hide();
                        // dialog.hide();
                        Toast.makeText(RealestateViewAds.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
