...
public class MatrimonyEditProfile extends AppCompatActivity {
    ProgressDialog pDialog;
    private RecyclerView rv_matrimony;
    boolean userScrolled = false;
    private List<MatrimonyEditItem> matrimonyItems;
    MatrimonyEditAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matrimony_edit_profile);
        ActionBar actionBar=getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setTitle(R.string.editprofile);
        matrimonyItems=new ArrayList<MatrimonyEditItem>();
        ...
        rv_matrimony=(RecyclerView)findViewById(R.id.recycle_matrimony_editview);
        empryview=(TextView)findViewById(R.id.tv_matrimony_editview_empty_view);
        adapter=new MatrimonyEditAdapter(this,getApplicationContext(),matrimonyItems);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DatabaseInfo.MatrimonyEditviewURL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        pDialog.hide();
                        // dialog.hide();
                        Toast.makeText(MatrimonyEditProfile.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
    ...
    private void MatriFeed(JSONObject response) {
        ...
        try {
            ...
            for (int i = 0; i < feedArray.length(); i++) {
                ...
                MatrimonyEditItem item=new MatrimonyEditItem();
