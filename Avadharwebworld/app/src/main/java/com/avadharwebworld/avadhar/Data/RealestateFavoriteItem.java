...
public class RealestateFavoriteItem {
    private String id,name,proftype,image,mprofileid,price,details,location,avadharid;
    public RealestateFavoriteItem() {
    }
    public RealestateFavoriteItem(String name,String id,String proftype,String image,String religion,String mprofileid,String price,String details,String location,String avid) {
        this.name=name;
        this.id=id;
