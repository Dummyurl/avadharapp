...
public class JobMyVacancyAdapter extends RecyclerView.Adapter<JobMyVacancyAdapter.ViewHolder> {
    ...
    public JobMyVacancyAdapter(Activity activity,Context context,List<JobItem> item){
        this.mActivity=activity;
        this.mContext=context;
        this.jobItems=item;
    }
    @Override
    public JobMyVacancyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.realestateviewadslayout, parent, false);
        return new JobMyVacancyAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(JobMyVacancyAdapter.ViewHolder holder, int position) {
        ...
        holder.Name.setText(bind.getJobtitle());
...
//        holder.religion.setText(bind.getReligion());
        ...
        public ViewHolder(final View itemView) {
            ...
            delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    notifyItemRangeChanged(getAdapterPosition(),jobItems.size());
    ...
    public void  deleteProfile(final String uid, final String pid){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DatabaseInfo.DeleteMyJobVacancyURL,
