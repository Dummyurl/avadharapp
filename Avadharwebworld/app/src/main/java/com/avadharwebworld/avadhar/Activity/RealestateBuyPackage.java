...
public class RealestateBuyPackage extends AppCompatActivity {
    private Spinner property,typeofproperty,typeofactivity,typeofuser,country,state,city;
    private MaterialEditText expectedprice,moredetails;
    private RadioGroup plan;
    private Button submit;
    private SharedPreferences sp;
    private String profileid,uid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_realestate_buy_package);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               if(property.getSelectedItemPosition()==0){
                ...
                else if(typeofuser.getSelectedItemPosition()==0){
                    Toast.makeText(getApplicationContext(),"Please Select Type of User",Toast.LENGTH_SHORT).show();
                }

                else if((moredetails.getText().toString().length() < 1)) {
                    moredetails.setError("Please fill this field!!!");
                    moredetails.requestFocus();
                }
                else if(plan.getCheckedRadioButtonId()==0){
                   Toast.makeText(getApplicationContext(),"Please Select One Plan",Toast.LENGTH_SHORT).show();
    ...
    private void initialize(){
        property=(Spinner)findViewById(R.id.sp_realestate_buypackage_property);
        typeofproperty=(Spinner)findViewById(R.id.sp_realestate_buypackage_typeofproperty);
        typeofactivity=(Spinner)findViewById(R.id.sp_realestate_buypackage_typeofactivity);
        typeofuser=(Spinner)findViewById(R.id.sp_realestate_buypackage_typeofuser);
        country=(Spinner)findViewById(R.id.sp_realestate_buypackage_country);
        state=(Spinner)findViewById(R.id.sp_realestate_buypackage_state);
        city=(Spinner)findViewById(R.id.sp_realestate_buypackage_city);
        expectedprice=(MaterialEditText)findViewById(R.id.et_realestate_buypackage_price);
        moredetails=(MaterialEditText)findViewById(R.id.et_realestate_buypackage_more);
        plan=(RadioGroup)findViewById(R.id.rg_realestate_buypackage_plan);
        submit=(Button)findViewById(R.id.btn_realestate_buypackage_save);
    }
...
//                        pDialog.hide();
                        Toast.makeText(RealestateBuyPackage.this,error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
...
//                    Log.e("country code send",countrycode);
    ...
    public void setBuyPackage(){


        StringRequest stringRequest = new StringRequest(Request.Method.POST, DatabaseInfo.RealestateBuyPackageURL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.d("Volleyresponse",response.toString());
...
//                        pDialog.hide();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("catid", String.valueOf(subcategory.get(validateSpCode(property))));
                params.put("subcat", String.valueOf(category.get(validateSpCode(typeofproperty))));
                params.put("type1", String.valueOf(typeofactivity.getSelectedItem().toString()));

                params.put("tuser1", String.valueOf(typeofuser.getSelectedItem().toString()));
                params.put("location", String.valueOf(city.getSelectedItem().toString()));
                params.put("countryId", String.valueOf(countrycodid.get(validateSpCode(country))));
                params.put("idstate",String.valueOf(statecodeid.get(validateSpCode(state))));
                params.put("city1", String.valueOf(citycodeid.get(validateSpCode(city))));
                params.put("eprice1", String.valueOf(expectedprice.getText().toString()));
                String plan1=((RadioButton)findViewById(plan.getCheckedRadioButtonId())).getText().toString();
                String planid="0";
                if(plan.getCheckedRadioButtonId()==R.id.rb_realestate_buypackage_silver){planid="1";}
                else if(plan.getCheckedRadioButtonId()==R.id.rb_realestate_buypackage_gold){planid="2";}
                else if(plan.getCheckedRadioButtonId()==R.id.rb_realestate_buypackage_diamond){planid="3";}
             Log.e("radio group select",planid);
                params.put("realplan", String.valueOf(planid));
                params.put("adddes1", String.valueOf(moredetails.getText().toString()));
