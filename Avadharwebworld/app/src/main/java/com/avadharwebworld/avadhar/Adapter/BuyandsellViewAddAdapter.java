...
import com.avadharwebworld.avadhar.Activity.BuyandsellEditPost;
...
public class BuyandsellViewAddAdapter extends RecyclerView.Adapter<BuyandsellViewAddAdapter.ViewHolder> {
    ...
    public BuyandsellViewAddAdapter(Activity activity,Context context,List<BuyandSellItem> item){
        this.mActivity=activity;
        this.mContext=context;
        this.buyandSellItems=item;
    }
    @Override
    public BuyandsellViewAddAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.realestateviewadslayout, parent, false);
        return new BuyandsellViewAddAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(BuyandsellViewAddAdapter.ViewHolder holder, int position) {
        ...
        holder.status.setText(bind.getProftype());
...
//        holder.religion.setText(bind.getReligion());
        ...
        public ViewHolder(final View itemView) {
            ...
            edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent=new Intent(mContext,BuyandsellEditPost.class);
                    intent.setFlags( FLAG_ACTIVITY_NEW_TASK );
                    intent.putExtra("id",  eduItem.getMprofileid());
    ...
    public void  deleteProfile(final String uid, final String pid){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DatabaseInfo.BuyandsellDeleteProfileURL,
...
//                        setAnimationForFavoriteText(response,layout);
    ...
    public void upoladimage(String id){
        ...
        File photo=new File(Constants.BUYANDSELLIMAGE);
//        File resume=new File(resumepath);
        Log.e("resumepath",Constants.BUYANDSELLIMAGE);
...
//        final String finalLanguageknown = languageknown;
        ...
        client.post(DatabaseInfo.BuyandsellUploadImageURL, params, new AsyncHttpResponseHandler() {
