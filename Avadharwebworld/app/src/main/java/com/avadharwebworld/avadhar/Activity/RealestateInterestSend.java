...
public class RealestateInterestSend extends AppCompatActivity {
    ProgressDialog pDialog;
    private RecyclerView rv_realestate;
    boolean userScrolled = false;
    private List<RealestateItem> realestateFavoriteItems;
    RealestateInterestSendAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_realestate_interest_send);
        ActionBar actionBar=getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setTitle(R.string.interestsend);
        ...
        rv_realestate=(RecyclerView)findViewById(R.id.recycle_realestate_interestsend);
        empryview=(TextView)findViewById(R.id.tv_realestate_interest_send_empty_view);
        adapter=new RealestateInterestSendAdapter(this,getApplicationContext(),realestateFavoriteItems);
...
//        getMatriDetails();
    ...
    public void getMatriDetails() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DatabaseInfo.RealestateInterestSendURL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        pDialog.hide();
                        // dialog.hide();
                        Toast.makeText(RealestateInterestSend.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
