...
import com.avadharwebworld.avadhar.Adapter.RealestateFavoriteAdapter;
import com.avadharwebworld.avadhar.Data.MatrimonyFavoriteItem;
import com.avadharwebworld.avadhar.Data.RealestateFavoriteItem;
...
public class RealestateMyFavorites extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_realestate_my_favorites);
        ...
        rv_realestate=(RecyclerView)findViewById(R.id.recycle_realestate_favorite);
        empryview=(TextView)findViewById(R.id.tv_realestate_favorite_empty_view);
        adapter=new RealestateFavoriteAdapter(this,getApplicationContext(),realestateFavoriteItems);
...
//                                listAdapter.
    ...
    public void getMatriDetails() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DatabaseInfo.RealestateViewFavoriteURL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        pDialog.hide();
                        // dialog.hide();
                        Toast.makeText(RealestateMyFavorites.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
