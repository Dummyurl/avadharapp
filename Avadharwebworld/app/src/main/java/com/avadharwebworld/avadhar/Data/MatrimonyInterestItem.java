...
public class MatrimonyInterestItem {
    private String id,name,proftype,religion,image,mprofileid;
    public MatrimonyInterestItem() {
    }
    public MatrimonyInterestItem(String name,String id,String proftype,String image,String religion,String mprofileid) {
        this.name=name;
        this.id=id;
