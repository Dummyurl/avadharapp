...
public class HisstoryAdapter2 extends RecyclerView.Adapter<HisstoryAdapter2.ViewHolder> {
    ...
    public HisstoryAdapter2(Activity activity,Context context,List<HisstoryItem> item){
        this.mActivity=activity;
        this.mContext=context;
        this.hisstoryItems=item;
    }
    @Override
    public HisstoryAdapter2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.hisstory_view2, parent, false);
        return new HisstoryAdapter2.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(HisstoryAdapter2.ViewHolder holder, int position) {
        final HisstoryAdapter2.ViewHolder holder1=holder;
...
////        holder.religion.setText(bind.getReligion());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
            ...
            readmore=(Button)itemView.findViewById(R.id.btn_hisstory2_readmore);

            Name=(TextView)itemView.findViewById(R.id.tv_hisstory_view2_name);
            date=(TextView)itemView.findViewById(R.id.tv_hisstory2_time);
            description=(TextView)itemView.findViewById(R.id.tv_hisstory_view2_content);
            title=(TextView)itemView.findViewById(R.id.tv_hisstory_view2_title);
            image=(NetworkImageView) itemView.findViewById(R.id.iv_hisstory_view2_image);
...
//                        setAnimationForFavoriteText(response,layout);
            ...
            protected Map<String, String> getParams() {
                ...
                Log.e("post id",String.valueOf(pid));
                Log.e("rating point",String.valueOf(rating));
                return params;
            }
