...
public class MatrimonyRequestAdapter extends RecyclerView.Adapter<MatrimonyRequestAdapter.ViewHolder> {
    ...
    public MatrimonyRequestAdapter(Activity activity,Context context,List<MatrimonyRequestItem> item){
        this.mActivity=activity;
        this.mContext=context;
        this.matrimonyItems=item;
    }
    @Override
    public MatrimonyRequestAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.matrimonyprofilerequestlayout, parent, false);
        return new MatrimonyRequestAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(MatrimonyRequestAdapter.ViewHolder holder, int position) {
        sp=mContext.getSharedPreferences(Constants.PREF_NAME, MODE_PRIVATE);
        sp_uid=sp.getString(Constants.UID,"");
        MatrimonyRequestItem bind=matrimonyItems.get(position);
...
//            thump=(ImageView)itemView.findViewById(R.id.iv_matrimony_thump);
            Name=(TextView)itemView.findViewById(R.id.tv_matrimony_profilerequest_name);
//            status=(TextView)itemView.findViewById(R.id.tv_matrimony_editview_status);
            accept=(Button) itemView.findViewById(R.id.btn_matrimony_profilerequest_accept);
            reject=(Button)itemView.findViewById(R.id.btn_matrimony_profilerequest_reject);
...
//                    Toast.makeText(mContext,"item position " +String.valueOf(getLayoutPosition()),Toast.LENGTH_SHORT).show();
                    MatrimonyRequestItem eduItem=matrimonyItems.get(getLayoutPosition());


                    //********* accept method add here***///////
