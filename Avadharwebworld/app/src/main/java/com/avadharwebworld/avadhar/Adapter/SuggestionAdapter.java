...
/**
 * Created by user-03 on 12/23/2016.
 */
...
public class SuggestionAdapter  extends RecyclerView.Adapter<SuggestionAdapter.ViewHolder> {
    ...
    public SuggestionAdapter(Activity activity, Context context, List<SuggestionItem> item) {
        this.mActivity = activity;
        this.mContext = context;
        this.suggestionItems = item;
    }

    @Override
    public SuggestionAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.follow_suggestion, parent, false);
    ...
    public void onBindViewHolder(SuggestionAdapter.ViewHolder holder, int position) {
        SuggestionItem bind = suggestionItems.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
            ...
            name = (TextView) itemView.findViewById(R.id.followSuggestion_name);
            coverphoto = (ProfileImageView) itemView.findViewById(R.id.followSuggestion_coverimage);
            btnFollow = (Button) itemView.findViewById(R.id.followSuggestion_btn_follow);
            profilepic = (ProfileImageView) itemView.findViewById(R.id.followSuggestion_profileimage);
...
//                Log.e("messagefull", String.valueOf(Arrays.asList(objsocial.msgIDFULL)));
                String[] flw = Constants.Suggetionid;
